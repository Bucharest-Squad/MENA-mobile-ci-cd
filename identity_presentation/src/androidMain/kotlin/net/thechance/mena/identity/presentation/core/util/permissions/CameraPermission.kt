...
import net.thechance.mena.identity.presentation.core.util.permissions.util.handleAfterAndBeforePermissionState
import net.thechance.mena.identity.presentation.core.util.permissions.util.handlePermissionState
...
internal class CameraPermission(
    ...
    override suspend fun requestPermission(): PermissionState {
        ...
        return handleAfterAndBeforePermissionState(
