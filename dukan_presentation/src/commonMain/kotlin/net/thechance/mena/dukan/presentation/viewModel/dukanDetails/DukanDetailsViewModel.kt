...
import net.thechance.mena.dukan.presentation.util.SavedStateHandleArgs
...
class DukanDetailsViewModel(
    ...
    val dukanId: String = requireNotNull(savedStateHandle[SavedStateHandleArgs.DUKAN_ID])
