...
fun ChatsMainScreen(
    ...
    val fakeData = listOf(
        ...
        ChatsScreenState.ChatUiState(
            ...
            time = "11:24 PM",
            status = ChatsScreenState.ChatUiState.Status.Read,
            isMine = true,
        ),
        ChatsScreenState.ChatUiState(
            id = Uuid.random(),
            ...
            time = "Yesterday",
            status = ChatsScreenState.ChatUiState.Status.UnRead(3),
            isMine = false,
        ),
        ChatsScreenState.ChatUiState(
            id = Uuid.random(),
            ...
            time = "17-03-2025",
            status = ChatsScreenState.ChatUiState.Status.Received,
            isMine = false,
        ),
        ChatsScreenState.ChatUiState(
            id = Uuid.random(),
